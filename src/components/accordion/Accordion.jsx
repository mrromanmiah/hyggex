...
const Accordion = () => {
    return (
        <div className="lg:mb-40 md:mb-28 mb-16">
            <h1 className="text-4xl font-bold bg-gradient-to-b from-[#06286E] to-[#164EC0] inline-block text-transparent bg-clip-text lg:mt-20 md:mt-10 mt-8 lg:mb-10 md:mb-7 mb-5">FAQ</h1>
